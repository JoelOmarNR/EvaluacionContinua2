package com.jonr.loginsqlite.content;
...
public class Products {
    ...
    public Products(String title, String dynamicUrl, String url, String price, String description) {
        this.title = title;
    ...
    public static List<Products> initProductsList (Resources resources) {
